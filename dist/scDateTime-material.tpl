    ...
    <div class="slider"> 
      <div class="date-control">
        <div class="title">
          ...
          <input ng-model="calendar._year" ng-change="calendar.yearChange()" type="number" min="{{restrictions.mindate ? restrictions.mindate.getUTCFullYear() : 0}}" max="{{restrcitions.maxdate ? restrictions.maxdate.getUTCFullYear() : NaN}}" class="year-part"/>

      ...
      controller: [
        '$scope', 'scDateTimeI18n', function(scope, scDateTimeI18n) {
          ...
          scope.$watch('clock._seconds', function(val, oldVal) {
            if ((val != null) && val !== (scope.date.getSeconds() + scope.date.getMilliseconds() * 0.001) && !isNaN(val) && (0 <= val && val <= 59)) {
